 ...
 * syncPlayers.js
 *
 * Rewrites playersList.js so it loads player data from the raw GitHub URL
 * instead of embedding local JSON imports.
 *
...
fs.writeFileSync(PLAYERS_LIST_FILE, playersListSource);
console.log('playersList.js synchronized with remote fetch support.');
